...
{/if}
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel name="middleName" key="user.middleName"}</td>
		<td class="hidden"><input type="text" name="middleName" id="middleName" value="{$middleName|escape}" size="20" maxlength="40" class="textField" /></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel suppressId="true" name="gender" key="user.gender"}</td>
		<td class="hidden">
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel name="initials" key="user.initials"}</td>
		<td class="hidden"><input type="text" name="initials" id="initials" value="{$initials|escape}" size="5" maxlength="5" class="textField" />&nbsp;&nbsp;{translate key="user.initialsExample"}</td>
	</tr>
	{if not $userId}
	<tr valign="top">
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel name="affiliation" key="user.affiliation"}</td>
		<td class="hidden">
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel name="signature" key="user.signature"}</td>
		<td class="hidden"><textarea name="signature[{$formLocale|escape}]" id="signature" rows="5" cols="40" class="textArea">{$signature[$formLocale]|escape}</textarea></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel name="orcid" key="user.orcid"}</td>
		<td class="hidden"><input type="text" name="orcid" id="orcid" value="{$orcid|escape}" size="30" maxlength="255" class="textField" /></td>
	</tr>
	<tr valign="top">
		<td class="hidden">{fieldLabel name="userUrl" key="user.url"}</td>
		<td class="hidden"><input type="text" name="userUrl" id="userUrl" value="{$userUrl|escape}" size="30" maxlength="255" class="textField" /></td>
	</tr>
	<tr valign="top">
		<td class="hidden">{fieldLabel name="phone" key="user.phone"}</td>
		<td class="hidden"><input type="text" name="phone" id="phone" value="{$phone|escape}" size="15" maxlength="24" class="textField" /></td>
	</tr>
	<tr valign="top">
		<td class="hidden">{fieldLabel name="fax" key="user.fax"}</td>
		<td class="hidden"><input type="text" name="fax" id="fax" value="{$fax|escape}" size="15" maxlength="24" class="textField" /></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		<td class="hidden">{fieldLabel name="mailingAddress" key="common.mailingAddress"}</td>
