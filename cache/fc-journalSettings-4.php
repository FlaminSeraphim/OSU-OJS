<?php return array (
  ...
  'emailHeader' => 'The following message is being delivered on behalf of Yale Journal of International Affairs.
________________________________________________________________________',
  'emailSignature' => '________________________________________________________________________
Yale Journal of International Affairs
http://10.21.137.55/ojs/index.php/YaleJ',
  'fastTrackFee' => 0,
  'itemsPerPage' => 25,
  ...
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/ojs/index.php/YaleJ/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/ojs/index.php/YaleJ/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/ojs/index.php/YaleJ/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/ojs/index.php/index/login">log in</a> and begin the five-step process.',
  ),
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'description' => 
  array (
    'en_US' => '<a href="http://yalejournal.org">http://yalejournal.org</a>',
  ),
  ...
  array (
    'en_US' => 
    array (
      'name' => 'Yale Journal.png',
      'uploadName' => 'journalThumbnail_en_US.png',
      'width' => 264,
      'height' => 82,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-01 13:04:28',
    ),
  ),
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/ojs/index.php/YaleJ/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/ojs/index.php/YaleJ/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://10.21.137.55/ojs/index.php/YaleJ/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://10.21.137.55/ojs/index.php/YaleJ/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
  ),
  ...
  'title' => 
  array (
    'en_US' => 'Yale Journal of International Affairs',
  ),
  'waiverPolicy' => 
  array (
