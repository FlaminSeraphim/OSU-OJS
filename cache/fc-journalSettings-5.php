<?php return array (
  ...
  'emailHeader' => 'The following message is being delivered on behalf of The OSU JOURNAL.
________________________________________________________________________',
  'emailSignature' => '________________________________________________________________________
The OSU JOURNAL
http://10.21.137.55/ojs/index.php/OSUJ',
  ...
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/ojs/index.php/OSUJ/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/ojs/index.php/OSUJ/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/ojs/index.php/OSUJ/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/ojs/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  'description' => 
  array (
    'en_US' => 'This is a journal from OSU-CHS. You will find research on general topics for health, and much much more!.',
  ),
  ...
  array (
    ...
    array (
      ...
      'height' => 56,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-01 15:24:56',
    ),
  ),
  'journalThumbnail' => 
  array (
    ...
    array (
      ...
      'height' => 56,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-01 15:24:07',
    ),
  ),
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/ojs/index.php/OSUJ/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/ojs/index.php/OSUJ/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://10.21.137.55/ojs/index.php/OSUJ/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://10.21.137.55/ojs/index.php/OSUJ/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
  ),
