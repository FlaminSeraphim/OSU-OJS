<?php /* Smarty version 2.6.26, created on 2016-08-01 13:14:31
...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td class="hidden"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.salutation"), $this);?>
</td>
		<td class="hidden"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['user']->getSalutation())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
	</tr>
	<tr valign="top">
