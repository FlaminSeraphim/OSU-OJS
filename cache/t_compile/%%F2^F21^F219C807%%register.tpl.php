<?php /* Smarty version 2.6.26, created on 2016-08-03 12:44:33
...
" size="20" maxlength="90" class="textField" /></td>
		...
		<tr valign="top">
			...
			<td class="hidden"><input type="text" id="initials" name="initials" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['initials'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" size="40" maxlength="255" class="textField" /><br /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.orcid.description"), $this);?>
		...
		<tr valign="top">
			...
			<td class="hidden"><input type="text" id="userUrl" name="userUrl" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['userUrl'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" size="15" maxlength="24" class="textField" /></td>
		...
		<tr valign="top">
			<td class="hidden"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'biography','key' => "user.biography"), $this);?>
